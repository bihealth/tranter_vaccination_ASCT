---
title: "OMIX001295-01 processing"
output: 
  html_document:
    df_print: paged
    code_folding: hide
...
reference <- readRDS(file.path('R',"PBMC_vaccine_CITE.rds"))
```

load PBMC data from [OMIX001295-01]( https://doi.org/10.1002/jmv.28012); take all cells with less than 10% mitochondrial RNA and between 250 and 5000 genes

- no injection (n=6)
- first injection (n=6)
- second infection (n=6)

```{r get_data}
samples <- c(outer(c('NJ-','FJ-','SJ-'),seq(1,6),FUN=paste0))
