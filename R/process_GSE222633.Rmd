---
title: "re-processing of GSE222633"
output: 
  html_document:
    df_print: paged
    code_folding: hide
...
load allo ref PBMC data; take all cells with less than 10% mitochondrial RNA and between 250 and 5000 genes
...
```{r get_data}
samples <- c("D10post","D10pre","D26post","D26pre","D29post","D16pre","D16post",
             "R10d180","R26d180","R29d180","R16d180")

pbmc <- list()
for (sample in samples) {
  dge <- Read10X_h5(file.path('cellranger',paste0(sample,'_filtered_counts.h5')))[['Gene Expression']]
